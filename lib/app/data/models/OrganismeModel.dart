...
List<Organisme> postFromJson(String str) =>
    List<Organisme>.from(json.decode(str).map((x) => Organisme.fromMap(x)));
...
class Organisme {
  ...
  factory Organisme.fromMap(Map<String, dynamic> json) => Organisme(
    numSoc: json["numSoc"],
    desSoc: json["desSoc"],
    adrSoc: json["adrSoc"],
    telSoc: json["telSoc"],
